...
<p align="center">Polish translations for WonderCMS (by pawell0)</p>

<br><br>

This plugin adds Polish translations to the WonderCMS admin area, based on `https://github.com/StephanStanisic/zlanguage-nl_NL` (experimental version). Plugin author: Stephan Stanisic.
